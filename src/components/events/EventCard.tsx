    ...
    <article className="card-lift bg-white rounded-2xl overflow-hidden group">
      ...
      <div className="relative h-48 overflow-hidden bg-gray-100">
        ...
        <div className="absolute top-3 left-3 bg-white rounded-xl shadow-md text-center px-3 py-2 min-w-[3.5rem]">
          <p className="text-[10px] font-bold text-crimson tracking-wider">{month}</p>
      ...
      <div className="p-5">
        ...
        <div className="space-y-1.5 mb-4">
          <div className="flex items-center gap-2 text-sm text-ink-soft">
            <svg className="w-4 h-4 text-crimson flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
