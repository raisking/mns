    ...
    <>
      ...
      {!shoutoutOpen && (
        <button
          ...
          className="fixed bottom-6 right-6 z-40 inline-flex items-center gap-2 bg-saffron hover:bg-saffron-dark text-white text-sm font-bold pl-3 pr-4 py-2.5 rounded-full shadow-lg transition-colors"
        >
          Shoutouts
        </button>
      )}
