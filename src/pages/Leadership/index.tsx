    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="flex flex-wrap gap-3 justify-center mb-12">
          ...
          <Link to="/leadership/committee-archive" className="px-5 py-2.5 bg-white border-2 border-gray-200 text-gray-700 text-sm font-semibold rounded-lg hover:border-saffron hover:text-saffron transition-colors">
            Committee Archive
          </Link>
        </div>
