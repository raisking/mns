      ...
      <div className="bg-gradient-to-r from-gray-900 to-gray-800 text-white py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-300 text-lg max-w-2xl mx-auto">
            Learn about our community, history, mission, and vision.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <section id="mission" className="mb-20 scroll-mt-24">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-[#C41E3A] text-white rounded-2xl p-8">
            ...
            <div className="bg-[#1E40AF] text-white rounded-2xl p-8">
              <div className="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center mb-4">
                <span className="text-2xl">🌟</span>
              </div>
              ...
              {[
                ...
                <div key={i} className="flex gap-6">
                  <div className="flex flex-col items-center">
                    <div className="w-12 h-12 bg-[#C41E3A] text-white rounded-full flex items-center justify-center text-sm font-bold flex-shrink-0">
                      {item.year.slice(2)}
                    </div>
                    {i < 4 && <div className="w-0.5 bg-red-200 flex-1 mt-2" />}
                  </div>
                  <div className="pb-8">
                    <p className="text-sm text-[#C41E3A] font-semibold mb-1">{item.year}</p>
